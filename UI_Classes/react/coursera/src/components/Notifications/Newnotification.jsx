...
import {
  addnotificationForm,
  notificationFetchInput,
  editnotificationForm,
} from "../../Store/notifications/addNotificationaction";
...
class NewNotification extends Component {
  ...
  componentDidMount() {
    ...
    if (this.props.location.state != null) {
      ...
      this.state.scheduled_date =
        this.props.location.state.detail.scheduled_date;
      this.state.scheduled_time =
        this.props.location.state.detail.scheduled_time;
      ...
      this.state.message_status =
        this.props.location.state.detail.message_status;
      this.state.char_left =
        this.state.max_char - this.props.location.state.detail.message.length;
      this.state.selectedUserId =
        this.props.location.state.detail.selected_userid;
      this.state.SelectedUserName =
        this.props.location.state.detail.username?.map((name) => {
          return {
            first_name: name,
          };
        });
  ...
  onSelectItem = (selectedusers, ii) => {
    ...
    if (user_ids == null) {
      this.state.selectedUserId = selectedusers.map((id) => id.user_id);
    } else {
        ...
        <div className="container">
          <div className="row">
            <div className="col-12 col-sm-6 mb-4">
              ...
              <i
                style={{ color: "#43425d", margin: "10px" }}
            ...
            <div className="row row-eq-height">
              <div className="col-lg-6">
                <div className="message-card">
                  <div className="mb-3">
                    <h5 style={{ color: "#4d4f5c" }} className="mb-3">
                      <b>To</b>
                    </h5>
                    ...
                    <div className="row">
                      <div className="col-3">
                        <input
                          checked={this.state.sent_to == "all"}
                          type="radio"
                          id="defaultRadio"
                          name="sent_to"
                          value="all"
                      ...
                      <div className="col-6">
                        <input
                          checked={this.state.sent_to == "selected"}
                          type="radio"
                          id="defaultRadioone"
                          name="sent_to"
                          value="selected"
                    ...
                    {this.state.sent_to == "selected" ? (
                      <div className="row my-3">
                        <div
                          ...
                          className="col-md-6 addadency-sec"
                        >
                          <div>
                            <Multiselect
                  ...
                  />
                  <label style={{ color: "#8f9199", marginLeft: "20px" }}>
                    Characters Remaining: {this.state.char_left}
                  </label>
              ...
              <div className="col-lg-6">
                <div className="schedule-card">
                  <h5
                    style={{ marginLeft: "30px", color: "#4d4f5c" }}
                    className="mb-3"
                  >
                    <b>Scheduling*</b>
                  </h5>
                  ...
                  >
                    <input
                      ...
                      name="message_status"
                      value="sent"
                      checked={this.state.message_status == "sent"}
                  ...
                  <div style={{ marginTop: "20px" }} className="form-check">
                    <input
                      ...
                      name="message_status"
                      value="scheduled"
                      checked={this.state.message_status == "scheduled"}
                      onChange={(e) => this.handleChange(e, "message_status")}
                    />
                    <label
                      style={{ color: "#8f9199" }}
                  ...
                  {this.state.message_status == "scheduled" ? (
                    <div className="row m-3">
                      <div style={{ marginLeft: "10px" }} className="col-xl-5">
                        <div className="form-group">
                          <label
                            style={{ marginLeft: "0px", color: "#4d4f5c" }}
                          ...
                          <input
                            ...
                            onChange={(e) =>
                              this.handleChange(e, "scheduled_date")
                            }
                          />
                          <span className="text-danger">
                            {this.validator.message(
                      ...
                      <div style={{ marginLeft: "-15px" }} className="col-xl-4">
                        <div className="form-group">
                          <label
                            style={{ marginLeft: "0px", color: "#4d4f5c" }}
                            className="font-weight-bold"
                          ...
                          <input
                            ...
                            onChange={(e) =>
                              this.handleChange(e, "scheduled_time")
                            }
                          />
                          <span className="text-danger">
                            {this.validator.message(
                      ...
                      <div style={{ marginLeft: "-20px" }} className="col-xl-3">
                        <div className="form-group">
                          <label
                            style={{ marginLeft: "0px", color: "#848494" }}
                            className="font-weight-bold"
                          ></label>

                          <select
                            style={{ margin: "5px", height: "46px" }}
                            className="form-control"
                            name="timezone"
