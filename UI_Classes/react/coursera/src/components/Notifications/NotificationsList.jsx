...
class NotificationsList extends Component {
  ...
  listOfNotifications = (event, notificationType) => {
    ...
    if (notificationType == "all") {
      ...
      this.props.getScheduledNotifications();
    }
  };
  componentDidMount() {
  ...
  componentWillReceiveProps(nextProps) {
    this.state.notifications =
      nextProps.allNotificationsDetails.allnotifications.notifications;
    ...
    if (this.state.notifications.length === 0) {
      ...
      this.state.notifications =
        nextProps.allNotificationsDetails.allnotifications.notifications;
      this.state.filterNotification =
        nextProps.allNotificationsDetails.allnotifications.notifications.slice(
          this.state.offset,
          this.state.offset + this.state.perPage
        );

      const postData = this.state.notifications.map((pd) => (
        <React.Fragment></React.Fragment>
      ));
      this.setState({
        spinner: !this.state.spinner,
        pageCount: Math.ceil(
          this.state.notifications.length / this.state.perPage
        ),
        postData,
      });
    }
  ...
  receivedData() {
    this.state.slice = this.state.notifications.slice(
      this.state.offset,
      this.state.offset + this.state.perPage
    );
            ...
            <div style={{ width: "100%", float: "right" }}>
              ...
              >
                ...
                <input
                  ...
                  type="text"
                  ref={(ref) => (this.clearSearhText = ref)}
              ...
              <div style={{ width: "30%", float: "right" }}>
                ...
                <button
                  ...
                  onClick={() => this.onnewNotification()}
                >
                  New Notification
                </button>
              </div>
                ...
                <ul className="nav nav-tabs">
                  <li className="nav-item">
                    <a
                      ...
                      data-toggle="tab"
                      onClick={(event) => {
                        this.listOfNotifications(event, "all");
                      }}
                      href="#"
                    >
                      All
                  ...
                  <li className="nav-item">
                    <a
                      ...
                      data-toggle="tab"
                      onClick={(event) => {
                        this.listOfNotifications(event, "sent");
                      }}
                      href="#"
                    >
                      Sent
                  ...
                  <li className="nav-item">
                    <a
                      ...
                      data-toggle="tab"
                      onClick={(event) => {
                        this.listOfNotifications(event, "scheduled");
                      }}
                      href="#"
                    >
                      Scheduled
                    ...
                    <tbody>
                      {
                        ...
                        this.state.notifSearchInput.length ? (
                          this.state.notifSearchList.length ? (
                            this.state.notifSearchList
                              ?.slice(
                                this.state.offset,
                                this.state.offset + this.state.perPage
                              )
