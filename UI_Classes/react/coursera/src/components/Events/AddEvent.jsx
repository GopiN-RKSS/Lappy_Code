...
class AddEvent extends Component {
    ...
    componentDidMount() {
        ...
        if (this.props.location.state != null) {
            this.setState({
                organized_by: this.props.location.state.detail.organized_by,
                event_id: this.props.location.state.detail.event_id,
                eventtypeid: this.props.location.state.detail.eventtypeid,
                event_name: this.props.location.state.detail.event_name,
                chapterid: this.props.location.state.detail.chapterid,
                description: this.props.location.state.detail.description,
                prerequisites: this.props.location.state.detail.prerequisites,
                disclaimer: this.props.location.state.detail.disclaimer,
                start_date: this.props.location.state.detail.start_date,
                end_date: this.props.location.state.detail.end_date,
                noof_seats: this.props.location.state.detail.noof_seats,
                available_seats: this.props.location.state.detail.available_seats,
                notes: this.props.location.state.detail.notes,
                paid_event: this.props.location.state.detail.paid_event,
                self_register: this.props.location.state.detail.self_register,
                send_notifications: this.props.location.state.detail.send_notifications,
                active_status: this.props.location.state.detail.active_status,
                start_time:this.props.location.state.detail.start_time,
                end_time: this.props.location.state.detail.end_time
            })
        }
    }
    ...
    componentWillReceiveProps(nextProps) {
       // console.log("Success:- ", nextProps.addEventDetails)
                  ...
                  {this.props.location.state ?
                    ...
                    <div className="mb-3">
                        ...
                        <div className="row pb-3">
                            ...
                            <div className="col-md-3">
                                <div className="form-group">
                                    <label className="lehead">Chapter<span></span></label>
...
export default connect(mapStateToProps, { addEventForm, EventFetchInput, editEventtForm, getEventTypes })(AddEvent);
