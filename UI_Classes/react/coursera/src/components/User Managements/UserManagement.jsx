...
export default connect(mapStateToProps, { getActiveUsers, getAgencyUsers, getBigsUsers, getInActiveUsers, userdetailsData, userdeleteaction, useractivateaction })(UserManagement)
