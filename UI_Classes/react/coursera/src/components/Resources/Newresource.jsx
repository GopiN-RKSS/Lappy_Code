        ...
        <div className="row mt-3 mb-4">
          ...
          <div className="mb-3">
            <div>
              ...
              <input type="radio" className="custom-control-input" id="active_status" 
              ...
              <div className="custom-control custom-radio custom-control-inline"> 
              <input type="radio" className="custom-control-input" id="in_active_status" name="active_status" value="1"
                      onChange={(e) => this.handleChange(e, 'active_status')}/> 
