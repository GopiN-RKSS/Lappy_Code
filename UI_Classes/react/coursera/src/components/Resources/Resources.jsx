...
class Resources extends Component {
  ...
  componentDidMount() {
    ...
    this.props.getResourcesListdata();
  }
  ...
  receivedData() {
    ...
    console.log("For pagination 1 :- ", this.state.resources)
    // this.state.spinner= true
  ...
  searchHandler = (event) => {
    if (event.target.value.length === 0) {
      ...
      if (displayedSearch.length > 0) {
        ...
        this.setState({  ResourceSearchList: [],DefaultMessage:'No Resources Found.'})
      }
      //this.setState({ resources: displayedSearch, pageCount: Math.ceil(displayedSearch.length / this.state.perPage) })
    }
  }
    ...
    return (
      <div className="container">
        ...
        <div style={{ width: '100%', paddingTop: '20px', marginLeft: '0px' }} className="row">
          <div className="box">
            <center>
              {!this.state.resources.length ? <Spinner
                animation="border"
                role="status" >
            ...
            <div style={{ width: '103%' }} className="row">              
                <div className="mb-3 col-12 text-center">
                  <div className="table-responsive">
                    <table id="dataTable">
                    {!this.state.DefaultMessage.length>0? <thead>
                        <tr>
                          <th>Title</th>
                          <th>Description</th>
                          <th>Files</th>
