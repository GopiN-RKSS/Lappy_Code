            ...
            <div className="col-md-4 col-lg-3">
                <div className="useracount-sec">
                    <div style={{ marginTop: '50px' }}>
                        ...
                        {this.state.userdetails.lastapp_activity != null ?
                            <div>
                                <div style={{ display: 'flex', alignItems: 'center', margin: '10px' }}>
                                    <h8 style={{ width: '50%', display: 'flex', marginLeft: '10px' }}>Active Since </h8>
                                    {this.state.userdetails.active_since !== null ? <h8 style={{ width: '50%' }} className="text-green"> {moment(this.state.userdetails.active_since).format('MM/DD/YYYY')}</h8> : <h8 style={{ width: '50%', float: 'right' }} className="text-green">00/00/0000</h8>}
                                </div>
                                <hr className="hr-gray" />
                                <div style={{ display: 'flex', margin: '10px' }}>
                                    <h8 style={{ width: '50%', display: 'flex', marginLeft: '10px' }}>Last App Activity</h8>
                                    {this.state.userdetails.lastapp_activity !== null ? <h8 style={{ width: '50%' }} className="text-green"> {moment(this.state.userdetails.lastapp_activity).format('MM/DD/YYYY')}</h8> : <h8 style={{ width: '50%', float: 'right' }} className="text-green">00/00/0000</h8>}
                                </div>
                                <hr className="hr-gray" />
                                <div style={{ display: 'flex', alignItems: 'center', margin: '10px' }}>
