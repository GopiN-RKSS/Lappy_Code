...
} from "../../Store/userprofile/userdetailsaction";
...
class UserData extends Component {
  ...
  componentDidMount() {
    console.log("user", this.props.location.state.detail);
        ...
        <div className="row mt-3 mb-4">
          <div className="col-md-6">
            <div className="horizontal-container">
              {/* <label className="label-discount">User Management</label> */}
            </div>
          </div>
        </div>
        <div
          style={{ width: "110%", marginRight: "50px" }}
          className="row pt-5"
        >
          <AccountView
            user_id={this.props.location.state.detail.user_id}
          ...
          <div className="col-md-8 col-lg-8">
            <section style={{ width: "100%" }} className="holltab-sec">
                  ...
                  <ul class="nav nav-tabs">
                    <li class="nav-item">
                      <a
                        ...
                        data-toggle="tab"
                        onClick={(event) => {
                          this.activeSettings(event, "UserInformation");
                        }}
                        id="defaultOpen"
                        href="#"
                      >
                    ...
                    <li class="nav-item">
                      <a
                        ...
                        data-toggle="tab"
                        onClick={(event) => {
                          this.activeSettings(event, "AccountSettings");
                        }}
                        href="#"
                      >
                        Account Settings
                    ...
                    <li class="nav-item">
                      <a
                        ...
                        data-toggle="tab"
                        onClick={(event) => {
                          this.activeSettings(event, "PhotoGallery");
                        }}
                        href="#"
                      >
                        Photo Gallery
                    ...
                    <li class="nav-item">
                      <a
                        ...
                        data-toggle="tab"
                        onClick={(event) => {
                          this.activeSettings(event, "MyLittle");
                        }}
                        href="#"
                      >
                        My Little
                    ...
                    <li class="nav-item">
                      <a
                        ...
                        data-toggle="tab"
                        onClick={(event) => {
                          this.activeSettings(event, "eventHistory");
                        }}
                        href="#"
                      >
              ...
              {this.state.activeScreen == "UserInformation" ? (
                <UserInformation userdata={this.props.location.state.detail} />
              ) : this.state.activeScreen == "AccountSettings" ? (
                <AccountSettings
                  userId={this.props.location.state.detail.user_id}
                />
                ...
                <MyLittle
                  userId={this.props.location.state.detail.user_id}
                  littleId={this.state.userdetails.mylittle_id}
                />
