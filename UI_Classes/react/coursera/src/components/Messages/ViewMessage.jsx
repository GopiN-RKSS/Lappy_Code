...
//       var drafthtml = draftToHtml(
//         convertToRaw(
//           this.props.sendMessage.sendMessageDetails.draftbody.getCurrentContent()
//         )
//       );
//     }
...
//                   onClick={() => this.onDelete(this.state.message.message_id)}
//                 >
...
//                         src={this.state.message.profile_pic}
//                         width="50"
//                         height="50"
//                       ></img>
//                     </div>
...
//                       <h8>
//                         <b>
//                           {this.state.message.first_name +
//                             " " +
//                             this.state.message.last_name}
//                         </b>{" "}
...
//                         __html: this.state.message.body,
//                       }}
//                     ></div>
//                   )}
//                 </div>
