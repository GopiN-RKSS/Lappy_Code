...
//   sendMessageForm,
//   ToUsersListData,
// } from "../../Store/messages/sendMessageAction";
...
//       <h8>
//         <b>{suggestion.first_name + " " + suggestion.last_name}</b>
//       </h8>
//     </div>
//   );
...
//     this.getSuggestions(eventInput).then((data) => {
//       if (data.Error) {
//         this.setState({
//           suggestions: [],
//         });
...
//       this.state.message_id = this.props.data.item.message_id;
//       this.state.email = this.props.data.item.email;
//       this.state.display_name =
//         this.props.data.item.first_name + " " + this.props.data.item.last_name;
//       this.state.subject = this.props.data.item.subject;
//       this.state.body = this.props.data.item.body;
//     } else {
...
//             onSuggestionsFetchRequested={(ev) =>
//               this.onSuggestionsFetchRequested(ev, "email")
//             }
